    ...
    <div className="min-h-screen flex items-center justify-center bg-[#0B1120] p-4 relative overflow-hidden font-sans">
      ...
      <div className="relative w-full max-w-[400px] animate-fade-in z-10 flex flex-col gap-8">
        ...
        <div className="flex flex-col gap-6 items-center">
          ...
          <div className="flex items-center p-1.5 gap-2 bg-black/20 border border-white/[0.05] rounded-full">
            {['uz', 'ru'].map(lang => (
              <button
                key={lang}
                onClick={() => changeLanguage(lang)}
                className={`flex items-center justify-center px-5 py-2 rounded-full text-[10px] font-bold tracking-[0.15em] uppercase transition-all duration-300 cursor-pointer whitespace-nowrap shrink-0 ${
                  i18n.language === lang
                    ? 'bg-blue-600/50 text-white shadow-[0_0_20px_rgba(37,99,235,0.4)]'
